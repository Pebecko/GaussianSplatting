...
void DemoState::appendGaussianSplat(GaussianSplat gaussianSplat) {
	this->rendering.gaussianSplats.push_back(gaussianSplat);
	this->rendering.renderingSettings.totalGaussians = this->rendering.gaussianSplats.size();
}
